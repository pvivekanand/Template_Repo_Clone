	...
	return Object.extend("nw.epm.refapps.purchaseorders.approve.controller.SubControllerForApproval", {
		...
		onConfirmActionPressed: function() {
			...
			var oApprover = this._oParentView.getController().getApplication().oApprover,
				oWhenApprovalIsDone = oApprover.approve(this._bApprove, false, this._oParentView, aPOIds, sApprovalNote);
			oWhenApprovalIsDone.then(this._fnApproveActionFinished.bind(null, true), this._fnApproveFailed);
		...
		// in the definition of fragment nw.epm.refapps.ext.po.apv.view.fragment.ApprovalDialog.
		onCancelActionPressed: function() {
